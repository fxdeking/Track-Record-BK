                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ route('profilupdatenama', [Auth::user()->id]) }}" method="POST">@csrf
                                <div class="modal-content bg-secondary bg-gradient">
                                    ...
                                    <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ Auth::user()->name }}" id="floatingInput" autocomplete="nama" autofocus>
                                    @error('nama')
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ route('profilupdateemail', [Auth::user()->id]) }}" method="POST">@csrf
                                <div class="modal-content bg-secondary bg-gradient">
                                    ...
                                    <div class="modal-body">
                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ Auth::user()->email }}" id="floatingInput" autocomplete="email" autofocus>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="modal-dialog" role="document">
                            <form action="{{ route('profilupdatetelepon', [Auth::user()->id]) }}" method="POST">@csrf
                                <div class="modal-content bg-secondary bg-gradient">
                                    ...
                                    <div class="modal-body">
                                    <input id="telepon" type="text" class="form-control @error('telepon') is-invalid @enderror" name="telepon" value="{{ Auth::user()->telepon }}" id="floatingInput" autocomplete="telepon" autofocus>
                                    @error('telepon')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
