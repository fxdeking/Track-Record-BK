...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h3 class="mb-0" style="color:red;">Ubah Data Pengunjung</h4>
        </div>
        ...
        @endif
        <form action="{{ route('pengupdate', [$pengunjung->id]) }}" method="POST">@csrf
            <div class="form-floating mb-3">
                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama"
                    value="{{ $pengunjung->nama }}" id="floatingInput" placeholder="name@example.com"
            ...
            <div class="form-floating mb-3">
                <input id="kelas" type="text" class="form-control @error('kelas') is-invalid @enderror" name="kelas"
                    value="{{ $pengunjung->kelas }}" id="floatingInput" placeholder="name@example.com"
            ...
            <div class="form-floating mb-3">
                <input id="usia" type="number" class="form-control @error('usia') is-invalid @enderror" name="usia"
                    value="{{ $pengunjung->usia }}" id="floatingInput" placeholder="name@example.com"
            ...
            <div class="form-floating mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" name="jk" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="Laki-laki" {{ ($pengunjung->jk=="Laki-laki")? "checked" : "" }}>
                    <label class="form-check-label" for="flexRadioDefault1">
                        Laki-laki
                    </label>
                    <input class="form-check-input" name="jk" style="margin-left:27px;" type="radio" name="flexRadioDefault" id="flexRadioDefault1" value="Perempuan" {{ ($pengunjung->jk=="Perempuan")? "checked" : "" }}>
            ...
            <div class="form-floating mb-3">
                <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" rows="2" style="height:100%;" id="floatingInput" placeholder="name@example.com"
                    autocomplete="alamat" autofocus>{{ $pengunjung->alamat }}</textarea>
            ...
            <div class="form-floating mb-3">
                <input id="notelp" type="number" class="form-control @error('notelp') is-invalid @enderror" name="notelp"
                    value="{{ $pengunjung->notelp }}" id="floatingInput" placeholder="name@example.com"
            ...
            <div class="mb-3">
                <select class="form-select mb-3 p-3" aria-label="Default select example" name="kategori_id">
                    ...
                    <option value="{{ $kategori->id }}" {{ ($pengunjung->kategori_id=="$kategori->id")? "selected" : "" }}>{{ $kategori->nama }}</option>
                    @endforeach
                </select>
                @error('kategori_id')
                <span class="invalid-feedback" role="alert">
